 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://iasri.com/", wsdlLocation = "http://localhost:8080/MyApp/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://iasri.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MyApp/ws/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://iasri.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://iasri.com/", "HelloPort"), Hello.class, features);
    }
